...
const PreTestForm = () => {
  ...
  return <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-yellow-400 mb-3">Pós Teste</h2>
        <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto">Preencha seus dados para responder o pós teste</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <Card className="bg-slate-800/50 border-slate-700">
          ...
          <CardContent className="space-y-8">
            {questions.map(question => <div key={question.id} className="space-y-4 p-4 bg-slate-700/30 rounded-lg">
