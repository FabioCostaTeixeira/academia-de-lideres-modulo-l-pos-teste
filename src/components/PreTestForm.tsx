  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">Academia de Líderes</h1>
              ...
              <div key={question.id} className="space-y-4 p-4 bg-slate-700/30 rounded-lg">
                ...
                <div className="mt-6 p-4 bg-slate-600/30 rounded-lg">
                  ...
                  <div className="space-y-4">
                    <Slider
                      value={formData[`conviccao${String(index + 1).padStart(2, '0')}` as keyof typeof formData] as number[]}
                      onValueChange={(value) => handleInputChange(`conviccao${String(index + 1).padStart(2, '0')}`, value)}
                      max={100}
                      step={1}
                      className="w-full"
                    />
                    ...
                    <div className="flex items-center justify-center space-x-4">
                      <img 
                        src={getConvictionImage((formData[`conviccao${String(index + 1).padStart(2, '0')}` as keyof typeof formData] as number[])[0])} 
